        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 mt-2">{{ Str::limit($project->description, 150) }}</p>
                    @if($project->technologies)
                        <div class="mt-4 flex flex-wrap gap-2">
                            @foreach(json_decode($project->technologies) as $tech)
                                <span class="px-3 py-1 bg-gray-200 rounded-full text-sm text-gray-700">{{ $tech }}</span>
                            @endforeach
                        </div>
                    @endif
                    <div class="mt-4 flex gap-4">
                        ...
                        @if($project->github_url)
                            <a href="{{ $project->github_url }}" target="_blank" class="text-gray-600 hover:text-gray-800 flex items-center">
                                <span>View Code</span>
